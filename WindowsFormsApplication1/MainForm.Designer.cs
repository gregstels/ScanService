namespace Mallenom.ScanNetwork.Gui
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			// _txtMimimum
			// 
			this._txtMimimum.Location = new System.Drawing.Point(205, 33);
			this._txtMimimum.Name = "_txtMimimum";
			this._txtMimimum.Size = new System.Drawing.Size(100, 20);
			this._txtMimimum.TabIndex = 5;
			this._txtMimimum.Text = "192.168.10.192";
			// 
			// _txtMaximum
			// 
			this._txtMaximum.Location = new System.Drawing.Point(327, 34);
			...
			this.Controls.Add(this._txtMaximum);
			this.Controls.Add(this._txtMimimum);
